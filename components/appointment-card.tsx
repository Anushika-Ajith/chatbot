...
const endTimeString = "2025-10-10T12:00:00.000Z";

const startTime = parseISO(startTimeString);
const formattedStartTime = format(startTime, 'h a');
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-foreground">{appointment.provider?.name}</h3>
